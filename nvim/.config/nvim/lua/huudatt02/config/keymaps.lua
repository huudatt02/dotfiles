...
-- quickfix
map("n", "[q", vim.cmd.cprev, "Previous Quickfix Item")
map("n", "]q", vim.cmd.cnext, "Next Quickfix Item")
map("n", "[Q", vim.cmd.colder, "Previous Quickfix List")
map("n", "]Q", vim.cmd.cnewer, "Next Quickfix List")
